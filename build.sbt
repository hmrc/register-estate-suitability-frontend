  ...
  .settings(
    ...
    Concat.groups := Seq(
      "javascripts/registerestatesuitabilityfrontend-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/registerestatesuitabilityfrontend.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("registerestatesuitabilityfrontend-*.js")
  )
