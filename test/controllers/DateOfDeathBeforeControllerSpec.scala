...
class DateOfDeathBeforeControllerSpec extends SpecBase {
  ...
  "DateOfDeathBefore Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[DateOfDeathBeforeView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DateOfDeathBeforePage, true).success.value
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, myNewPageRoute).withFormUrlEncodedBody(("value", "true"))
